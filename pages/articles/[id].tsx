  ...
  return (
    <div className="pt-[66px]">
      <div className="w-[720px] inset-x-0 mx-auto pt-5">
        ...
        <div className="flex flex-row items-center justify-between w-[92%] inset-x-0 mx-auto">
        ...
        <div className="py-6 w-[92%] inset-0 mx-auto border-y">
        ...
        <div className="w-[92%] inset-0 mx-auto py-8">
